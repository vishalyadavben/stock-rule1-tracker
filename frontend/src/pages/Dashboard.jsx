          ...
          <table>
            <thead>
              <tr>
                ...
                <th title="Buy price × quantity currently held">Invested ℹ️</th>
                <th>Current price</th>
                <th title="Current price − buy price, times quantity held">Unrealized gain ℹ️</th>
                <th title="Unrealized gain as a percentage of what you invested">% ℹ️</th><th></th><th></th><th></th><th></th>
              </tr>
            </thead>
            <tbody>
              {holdings.map((h) => (
                <React.Fragment key={h.lotId}>
                  <tr>
                    ...
                    <td><button title="Enter the current market price yourself" onClick={() => openManualPrice(h.lotId)}>✏️ Set current price manually</button></td>
                    <td><button onClick={() => openSell(h.lotId)}>Sell</button></td>
                    <td>{h.isPaperMoney && <button onClick={() => deleteLot(h.lotId, h.ticker)}>Delete</button>}</td>
                  </tr>
